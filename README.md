...
## Versión v6 Executive Retail

Versión visual orientada a una presentación ejecutiva de negocio retail: foco en ventas, margen, pricing, categorías, regiones y clientes. Incluye hero tipo command center, paleta supermarket/retail y tarjetas de decisión gerencial.
